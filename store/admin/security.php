...
<section class="grid gap-6 2xl:grid-cols-[460px_1fr]">
    <form method="post" class="admin-panel space-y-5 p-6">
        <div>
            <p class="admin-panel-kicker">Keamanan akses</p>
            <h3 class="mt-2 text-2xl font-black text-accent-900">Ganti password admin</h3>
            <p class="admin-panel-subtitle mt-2">Disarankan segera mengganti password default setelah store live agar panel tetap aman.</p>
        </div>
    ...
    <div class="space-y-6">
        <div class="admin-panel p-6">
            <p class="admin-panel-kicker">Checklist</p>
            <h3 class="mt-2 text-xl font-black text-accent-900">Checklist keamanan</h3>
        ...
        <div class="admin-dark-card p-6">
            ...
            <p class="mt-3 text-sm text-slate-200">Login sebagai <strong><?= e($_SESSION['admin_username'] ?? 'admin') ?></strong>.</p>
        </div>
    </div>
</section>
